                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= isset($_SESSION['nome']) ? 'is-invalid' : '' ?>" name="nome" id="nome" aria-describedby="Nomefabricante" value="<?= $this->e(getOld('nome')) ?>" placeholder="Nome do Módulo">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= isset($_SESSION['site']) ? 'is-invalid' : '' ?>" name="site" id="site" value="<?= $this->e(getOld('site')) ?>" placeholder="Site">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= isset($_SESSION['contato']) ? 'is-invalid' : '' ?>" name="contato" value="<?= $this->e(getOld('contato')) ?>" placeholder="Contato">
