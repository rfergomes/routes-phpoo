            ...
            <div class="card-header py-1 bg-white">
                <div class="row py-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <?php if (can($moduloId, 'adicionar')): ?>
                            <a href="/fabricante/create" class="btn btn-sm btn-primary" title="Cadastrar Usuário">Nova fabricante</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="datatable-top py-0 ">
                    <div class="datatable-dropdown">
                        ...
                        <form method="get" action="/fabricante" class="form-search d-flex">
                            ...
                            <tbody>
                                ...
                                if (!empty($fabricantes)) :
                                    foreach ($fabricantes as $fabricante) : ?>
                                        <tr data-index="<?= $Cont; ?>">
                                            <td><?= $this->e($fabricante->id); ?></td>
                                            <td> <?= $this->e($fabricante->nome); ?></td>
                                            <td><a href="<?= $this->e($fabricante->site); ?>"><?= $this->e($fabricante->site); ?></a></td>
                                            <td><a href="mailto:<?= $this->e($fabricante->contato); ?>"><?= $this->e($fabricante->contato); ?></a></td>
                                            <td>
                                                <div class="overlay-edit">
                                                    <ul class="list-inline me-auto mb-0">
                                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" aria-label="Visualizar" data-bs-original-title="Visualizar">
                                                            <a href="fabricante/show" class="avtar avtar-xs btn-link-warning btn-pc-default btn-view" data-bs-toggle="modal" data-bs-target="#userModal">
                                                                <i class="ti ti-eye f-18"></i>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item align-bottom">
                                                            <a href="/fabricante/edit/<?= $this->e($fabricante->id); ?>" class="avtar avtar-xs btn-link-success btn-pc-default btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                                                <i class="ti ti-edit-circle f-18"></i>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" aria-label="Excluir" data-bs-original-title="Excluir">
                                                            <a href="/fabricante/delete/<?= $this->e($fabricante->id); ?>" class="avtar avtar-xs btn-link-danger btn-pc-default btn-delete">
                                ...
                                <?php else : ?>
                                    <tr>
                                        <td colspan="5" class="text-center text-danger">Nenhuma fabricante encontrado.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
