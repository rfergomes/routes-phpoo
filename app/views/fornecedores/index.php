            ...
            <div class="card-header py-1 bg-white">
                <div class="row py-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <?php if (can($moduloId, 'adicionar')): ?>
                            <a href="/fornecedor/create" class="btn btn-sm btn-primary" title="Cadastrar Usuário">Nova fornecedor</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="datatable-top py-0 ">
                    <div class="datatable-dropdown">
                        ...
                        <form method="get" action="/fornecedor" class="form-search d-flex">
                            ...
                            <tbody>
                                ...
                                if (!empty($fornecedores)) :
                                    foreach ($fornecedores as $fornecedor) : ?>
                                        <tr data-index="<?= $Cont; ?>">
                                            <td><?= $this->e($fornecedor->id); ?></td>
                                            <td> <?= $this->e($fornecedor->nome); ?></td>
                                            <td><?= $this->e($fornecedor->cnpj); ?></td>
                                            <td><?= $this->e($fornecedor->telefone); ?></td>
                                            <td>
                                                    ...
                                                    <ul class="list-inline me-auto mb-0">
                                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" aria-label="Visualizar" data-bs-original-title="Visualizar">
                                                            <a href="#" class="avtar avtar-xs btn-link-warning btn-pc-default btn-view"
                                                                ...
                                                                data-nome="<?= $this->e($fornecedor->nome); ?>"
                                                                data-cnpj="<?= $this->e($fornecedor->cnpj); ?>"
                                                                data-telefone="<?= $this->e($fornecedor->telefone); ?>"
                                                                data-email="<?= $this->e($fornecedor->email); ?>"
                                                                data-endereco="<?= $this->e($fornecedor->endereco); ?>">
                                                                <i class="ti ti-eye f-18"></i>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item align-bottom">
                                                            <a href="/fornecedor/edit/<?= $this->e($fornecedor->id); ?>" class="avtar avtar-xs btn-link-success btn-pc-default btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                                                <i class="ti ti-edit-circle f-18"></i>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" aria-label="Excluir" data-bs-original-title="Excluir">
                                                            <a href="/fornecedor/delete/<?= $this->e($fornecedor->id); ?>" class="avtar avtar-xs btn-link-danger btn-pc-default btn-delete">
                                ...
                                <?php else : ?>
                                    <tr>
                                        <td colspan="5" class="text-center text-danger">Nenhuma fornecedor encontrado.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<?= $this->insert('fornecedores/modal'); ?>
<?php $this->push('css') ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewButtons.forEach(button => {
            button.addEventListener('click', function() {
                const fornecedor = this.getAttribute('data-nome');
