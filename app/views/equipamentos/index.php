            ...
            <div class="card-header py-1 bg-white">
                <div class="row py-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <?php if (can($moduloId, 'adicionar')): ?>
                            <a href="/equipamento/create" class="btn btn-sm btn-primary" title="Cadastrar Usuário">Novo Equipamento</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="datatable-top py-0 ">
                    <div class="datatable-dropdown">
                        ...
                        <form method="get" action="/equipamento" class="form-search d-flex">
                            ...
                            <tbody>
                                ...
                                if (!empty($equipamentos)) :
                                    foreach ($equipamentos as $equipamento) : ?>
                                        <tr data-index="<?= $Cont; ?>">
                                            <td><?= $this->e($equipamento->id); ?></td>
                                            <td><p data-bs-toggle="tooltip" data-bs-original-title="<?= $this->e($equipamento->observacao); ?>"><?= $this->e($equipamento->nome); ?></p></td>
                                            <td><?= $this->e($equipamento->modelo); ?></td>
                                            <td><?= $this->e($equipamento->numero_serie); ?></td>
                                            <td class="">
                                                <div class="overlay-edit">
                                                    <ul class="list-inline me-auto mb-0">
                                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" aria-label="Visualizar" data-bs-original-title="Visualizar">
                                                            <a href="equipamento/show" class="avtar avtar-xs btn-link-warning btn-pc-default btn-view" data-bs-toggle="modal" data-bs-target="#userModal">
                                                                <i class="ti ti-eye f-18"></i>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item align-bottom">
                                                            <a href="/equipamento/edit/<?= $this->e($equipamento->id); ?>" class="avtar avtar-xs btn-link-success btn-pc-default btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                                                <i class="ti ti-edit-circle f-18"></i>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" aria-label="Excluir" data-bs-original-title="Excluir">
                                                            <a href="/equipamento/delete/<?= $this->e($equipamento->id); ?>" class="avtar avtar-xs btn-link-danger btn-pc-default btn-delete">
                                ...
                                <?php else : ?>
                                    <tr>
                                        <td colspan="5" class="text-center text-danger">Nenhuma equipamento encontrado.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
